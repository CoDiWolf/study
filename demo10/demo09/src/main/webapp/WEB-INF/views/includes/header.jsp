...
<nav class="navbar navbar-expand-md bg-dark navbar-blue mb-5">
<div class="container">
  <a class="navbar-brand" href="/">HOME</a>
    ...
    <ul class="navbar-nav mr-auto">
     ...
     <ul class="navbar-nav">
    	...
    	<sec:authorize access="isAuthenticated()">
    	<li class="nav-item"><a class="nav-link" href="/board/userlist">회원리스트</a></li>
    	<li class="nav-item"><a class="nav-link" href="/logout">로그아웃(<sec:authentication property="principal.user.username"/>)</a></li>
    	<li class="nav-item"><a class="nav-link" href="/board/userUpdate">회원변경</a></li>
    	</sec:authorize>
    </ul>
